...
We do not actually have a plan to work from yet, but pretend we do. How will you
proceed in building this model?

1. Clear off your workspace
***************************

Simple, we will set up on some flat surface we use for building.

2. Lay out your plan
********************

For now, we will imagine placing a clean white page big enough to handle the
...
together. If this all sounds familiar, it is probably because you took geometry in high
school! All measurements we will need to build our model will be defined in
this system.
...
*************************
	...
	* balsa wood strip stock (maybe you cut this from sheet stock)
	...
	* Glue (We wont be gluing anything for a while)
...
We will start off by building the fuselage of our model. This involves a motor
...
===============================================
	...
	* Sand the top part round for the mounting tubes
...
glue the tail boom to the aft side of the motor stick.
...
and wing tips tilted up to provide needed dihedrl for stability. The wing will
be constructed flat, covered, then dihedral will ba added as a final step. We
...
OpenSCAD.) Some builders use a full wing template ot assemble the wing
